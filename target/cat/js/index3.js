...
var localChannelOptions = {ordered: false, maxRetransmitTime: 3000,};
...
var downloadFileData = {"maxsize": 0, "filename": null, "data": []};
...
var pc_icecandidate = function (event) {
    if (event.candidate !== null) {
        var param = {
            ...
            value: {"event": "_ice_candidate", "data": {"candidate": event.candidate}}
        };
...
var sendOfferFn = function (desc) {
    ...
    var param = {key: "SIGNALLING_OFFER", value: {"event": "_offer", "data": {"sdp": desc}}};
    socket.sendJson(param)
}, sendAnswerFn = function (desc) {
    pc.setLocalDescription(desc);
    var param = {key: "SIGNALLING_OFFER", value: {"event": "_answer", "data": {"sdp": desc}}};
    socket.sendJson(param)
};
