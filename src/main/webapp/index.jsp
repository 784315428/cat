    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" name="ready" data-ready="false">接受</button>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                            ...
                            <div class="panel-footer" align="center">
                                <button type="button" class="btn btn-default btn-lg btn-xs" id="openVideo"
                                        data-use="false"><i
                                        class="glyphicon glyphicon-facetime-video"></i><span>发起视频</span></button>
                                <button type="button" class="btn btn-default btn-lg btn-xs" id="openAudio"
                                        data-use="false"><i class="glyphicon glyphicon-earphone"></i><span>发起语音</span>
                                </button>
                            </div>
                        </div>
                        <div class="panel panel-default" style="margin: 0px;padding: 0px;">
